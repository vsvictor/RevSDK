...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.main) {
            ...
            Intent launchIntent = getPackageManager().getLaunchIntentForPackage("com.nuubit.compatible");
            if (launchIntent != null) {
                startActivity(launchIntent);
            }
        } else if (id == R.id.tester) {
            Intent launchIntent = getPackageManager().getLaunchIntentForPackage("com.nuubit.tester");
            if (launchIntent != null) {
                startActivity(launchIntent);
            }
        }
