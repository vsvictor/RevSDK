...
import com.nuubit.racer.NuubitApp;
...
public class WebTaskFragment extends Fragment {
    ...
    public static WebTaskFragment newInstance() {
        WebTaskFragment fragment = new WebTaskFragment();
        return fragment;
    }
    ...
    public void onViewCreated(View view, Bundle state) {
        ...
        rlStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                edURL.clearFocus();
                Log.i(TAG, url.toString());
                listener.onWebStartTaskInSeries(sbSteps.getProgress(), sbSize.getProgress(), url.toString(), spMethod.getSelectedItem().toString(), spMime.getSelectedItem().toString());
            }
        });
        ...
        rlUnlim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                edURL.clearFocus();
                Log.i(TAG, url.toString());
                listener.onWebStartUnlimTaskSeries(sbSize.getProgress(), url.toString(), spMethod.getSelectedItem().toString(), spMime.getSelectedItem().toString());
            }
        });
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof MainFragment.OnMainListener) {
            listener = (OnWebTaskListener) context;
        } else {
    ...
    public interface OnWebTaskListener {
        void onWebStartTaskInSeries(int steps, long body, String url, String method, String type);
        void onWebStartTaskParelelly(int steps, long body, String url, String method, String type);
        void onWebStartUnlimTaskSeries(long body, String url, String method, String type);
    }
}
