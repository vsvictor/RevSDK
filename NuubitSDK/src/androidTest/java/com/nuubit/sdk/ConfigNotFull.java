...
public class ConfigNotFull extends ApplicationTestCase<NuubitApplication> {
    private static final String TAG = "newConfigNull";
    private NuubitApplication application;

    public ConfigNotFull() {
    ...
    @Test
    public void notFully() throws Exception {
        Field receiver = null;
        ...
        iRes.putExtra(NuubitConstants.CONFIG, "{\"app_name\":\"Tester\",\"os\":\"Android\",\"configs\":[{\"sdk_release_version\":1,\"logging_level\":\"debug\",\"configuration_refresh_interval_sec\":60");
