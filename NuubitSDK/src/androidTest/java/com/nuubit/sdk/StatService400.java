...
public class StatService400 extends ApplicationTestCase<NuubitApplication> {
    private final static String TAG = StatService400.class.getName();
    private NuubitApplication application;


    public StatService400() {
