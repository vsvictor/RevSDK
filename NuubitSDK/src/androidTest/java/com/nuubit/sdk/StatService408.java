...
public class StatService408 extends ApplicationTestCase<NuubitApplication> {
    private final static String TAG = StatService408.class.getName();
    private NuubitApplication application;


    public StatService408() {
    ...
    public void startStat() {
        ...
        intent.putExtra(NuubitConstants.STATISTIC, "http://httpbin.org/status/408");
