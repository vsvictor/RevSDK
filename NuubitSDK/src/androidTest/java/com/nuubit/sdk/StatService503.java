...
public class StatService503 extends ApplicationTestCase<NuubitApplication> {
    private final static String TAG = StatService503.class.getName();
    private NuubitApplication application;


    public StatService503() {
    ...
    public void startStat() {
        ...
        intent.putExtra(NuubitConstants.STATISTIC, "http://httpbin.org/status/503");
