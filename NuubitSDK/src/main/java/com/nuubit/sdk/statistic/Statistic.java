...
public class Statistic extends Data implements Parcelable {
    ...
    public Statistic(Context context){
        ...
        setABMode(false);
        setIP(NuubitConstants.LOCAL_IP);
        setHits(NuubitConstants.HITS);
        setStartTS(NuubitConstants.BIG_NUMBER_1);
        setEndTS(NuubitConstants.BIG_NUMBER_2);
        setLevel(NuubitConstants.LEVEL);
