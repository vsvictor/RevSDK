...
public class App extends Data implements Parcelable {
    ...
    private void version(){
        ...
        try {
            pInfo = NuubitApplication.getInstance().getPackageManager().getPackageInfo(NuubitApplication.getInstance().getPackageName(), 0);
    ...
    private void appName(){
        this.appName = NuubitApplication.getInstance().getConfig().getAppName();
    }
    private void sdkKey(){
        this.sdkKey = NuubitApplication.getInstance().getSDKKey();
    }
    private void sdkVersion(){
        this.sdkVersion = NuubitApplication.getInstance().getConfig().getParam().get(0).getSdkReleaseVersion();
    }
