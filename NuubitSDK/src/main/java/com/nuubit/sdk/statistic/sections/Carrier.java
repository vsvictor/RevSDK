...
public class Carrier extends Data implements Parcelable {
    ...
    protected Carrier(Parcel in) {
        ...
        Carrier c = NuubitSDK.gsonCreate().fromJson(s, Carrier.class);
    ...
    private String networkType2String(int netType) {
        ...
        switch (netType) {
            ...
            default:
                result = NuubitConstants.UNDEFINED;
        }
        return result;
    }
    ...
    public static void runRSSIListener() {
        try {
            //Looper.prepare();
            TelephonyManager manager = (TelephonyManager) NuubitApplication.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
...
/*
        ...
        public void onCellLocationChanged(CellLocation location){
            Toast.makeText(NuubitApplication.getInstance(),"Cell change: "+ location.toString(), Toast.LENGTH_LONG).show();
        }
        @Override
        public void onCellInfoChanged (List<CellInfo> cellInfo){
            for(CellInfo cell : cellInfo) {
                Toast.makeText(NuubitApplication.getInstance(), "Cell info: " + cell.toString(), Toast.LENGTH_LONG).show();
