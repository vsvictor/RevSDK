...
public class RevContentProvider extends ContentProvider {
    private static final String TAG = RevContentProvider.class.getSimpleName();
    //private static final int APP_TABLE = 1;
    //private static final int REQUEST_TABLE = 2;
    public static String CONTENT_AUTHORITY = BuildConfig.APPLICATION_ID;
    //    private static final UriMatcher URI_MATCHER;
/*
    static {
        URI_MATCHER = new UriMatcher(UriMatcher.NO_MATCH);
        URI_MATCHER.addURI(CONTENT_AUTHORITY, AppTable.Requests.TABLE_NAME, APP_TABLE);
        URI_MATCHER.addURI(CONTENT_AUTHORITY, RequestTable.Requests.TABLE_NAME, REQUEST_TABLE);
    }
*/
    ...
    public boolean onCreate() {
        CONTENT_AUTHORITY = getContext().getApplicationContext().getPackageName();
        dbHelper = new DBHelper(getContext(), CONTENT_AUTHORITY);
        Log.i(TAG, CONTENT_AUTHORITY);
        return true;
    }
