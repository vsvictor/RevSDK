...
describe("Functional Interceptor", function () {
    describe("Adding SDK key to the headers. Transfer_and_report mode", function () {
        ...
        it("should check that domain from 'PROVISIONED' list won't return SDK key in headers", function () {
            return driverRevTester
                ...
                .then(function (els) {
                    return els.text().should.not.eventually.include(SDKkeyTester + headerRevSDK)
                })
        });
    });
});
