...
describe("Smoke: interceptor. operation mode transfer_only stats collecting", function () {
    ...
    it("need select operation mode 'report only' and compare values "+
        "(need they was not equal to each other) in "+
        "('Stats' => 'Request count') of 'open drawer' "+
        "then after 60 seconds compare values again", function () {
        return driver
