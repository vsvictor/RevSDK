...
wd.addPromiseChainMethod('getConfigValues', Config.getConfigValues);
...
describe("Smoke: default configuration", function () {
    ...
    it("should have a default config on the first initialization when cannot load config from API", function () {
